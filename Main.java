...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Stable stable = new Stable("John & melk's Horse Stable");
            ...
            if (!stable.isLoggedIn()) {
                ...
                switch (choice) {
                    case 1: {
                        ...
                        System.out.print("Role (ADMIN/MANAGER/STAFF): "); String role = sc.nextLine();
                        System.out.print("Username: ");   String user = sc.nextLine();
                        System.out.print("Password: ");   String pass = sc.nextLine();
                        stable.createStaff(id, name, role, user, pass);
                        System.out.println(stable.getLastMessage());
                        break;
                    }
                    case 2: {
                        ...
                        System.out.print("Sire (father): "); String sire = sc.nextLine();
                        System.out.print("Dam (mother): ");  String dam  = sc.nextLine();
                        stable.createHorse(hName, breed, color, gender,
                                           LocalDate.now(), LocalDate.now(),
                                           stallId, sire, dam, w, h);
                        System.out.println(stable.getLastMessage());
                        break;
                    }
                    case 3: {
                    ...
                    case 8: { stable.logout(); System.out.println(stable.getLastMessage()); break; }
                    case 0: { System.out.println("Goodbye!"); break; }
                    default: System.out.println("Invalid choice.");
                }
            }
